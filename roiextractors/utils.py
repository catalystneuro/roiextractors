...
def check_segmentations_equal(seg1: SegmentationExtractor, seg2: SegmentationExtractor):
    ...
    assert seg1.get_channel_names() == seg2.get_channel_names()
    assert seg1.get_image_size() == seg2.get_image_size()
    assert seg1.get_roi_image_masks() == seg2.get_roi_image_masks()
    assert seg1.get_roi_pixel_masks() == seg2.get_roi_pixel_masks()
    assert seg1.get_image() == seg2.get_image()
    assert seg1.get_accepted_list() == seg2.get_accepted_list()
    assert seg1.get_rejected_list() == seg2.get_rejected_list()
    assert seg1.get_roi_locations() == seg2.get_roi_locations()
    assert seg1.get_roi_ids() == seg2.get_roi_ids()
    assert seg1.get_traces() == seg2.get_traces()
    assert seg1.get_traces_dict() == seg2.get_traces_dict()
    assert seg1.get_images_dict() == seg2.get_images_dict()
...
def check_segmentation_return_types(seg: SegmentationExtractor):
    ...
    _assert_iterable_complete(seg.get_roi_pixel_masks()[0],
                              dtypes=(np.ndarray,),
                              element_dtypes=floattype,
