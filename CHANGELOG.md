...
* Removed deprecated `get_frames()` method from `ImagingExtractor` and `VolumetricImagingExtractor` (deprecated January 2026). Use `get_samples()` instead. [PR #541](https://github.com/catalystneuro/roiextractors/pull/541)
