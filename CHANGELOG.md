...
* Added volumetric imaging support with `is_volumetric` flag, `get_frame_shape`, `get_num_planes`, and `get_volume_shape` methods [PR #TBD](https://github.com/catalystneuro/roiextractors/pull/XXX)
