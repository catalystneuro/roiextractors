...
* Added `ScanImageImagingExtractor` for simplifying reading ScanImage data [#412](https://github.com/catalystneuro/roiextractors/pull/412) [PR # 417](https://github.com/catalystneuro/roiextractors/pull/417)
