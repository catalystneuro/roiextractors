...
class FrameConcatenatedImagingExtractorMixin(ImagingExtractorMixin):
...
class FrameConcatenatedFrameSliceImagingExtractorMixin(FrameSliceImagingExtractorMixin):
    @pytest.mark.parametrize("sampling_frequency", [1, 2, 3])
