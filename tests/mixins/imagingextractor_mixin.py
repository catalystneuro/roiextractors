...
class ImagingExtractorMixin:
    ...
    def imaging_extractor(self, imaging_extractor_kwargs):
        return self.imaging_extractor_cls(**imaging_extractor_kwargs)
    ...
    def test_eq(self, imaging_extractor, imaging_extractor_kwargs):
        imaging_extractor2 = self.imaging_extractor_cls(**imaging_extractor_kwargs)
