...
class TestFrameSliceImaging(TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.toy_data = np.random.random(size=[10, 5, 4, 1])
    ...
    def test_get_channel_names(self):
        assert self.frame_sliced_imaging.get_channel_names() is None
    ...
    def test_get_frames(self):
        assert_array_equal(self.frame_sliced_imaging.get_frames(frame_idxs=[2, 4]), self.toy_data[[4, 6], ...])
